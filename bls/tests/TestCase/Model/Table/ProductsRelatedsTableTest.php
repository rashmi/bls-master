...
use App\Model\Table\ProductsRelatedsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ProductsRelatedsTable Test Case
 */
class ProductsRelatedsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ProductsRelatedsTable
     */
    public $ProductsRelateds;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ProductsRelateds') ? [] : ['className' => 'App\Model\Table\ProductsRelatedsTable'];
        $this->ProductsRelateds = TableRegistry::get('ProductsRelateds', $config);
    }
