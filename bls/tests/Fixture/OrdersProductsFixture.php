...
class OrdersProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'discounted_price' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'final_price' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'discounted_price' => 'Lorem ipsum dolor sit amet',
            'final_price' => 'Lorem ipsum dolor sit amet',
            'created' => '2016-07-28 12:09:56',
            'modified' => '2016-07-28 12:09:56'
        ],
    ];
}
