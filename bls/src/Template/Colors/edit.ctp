...
<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2><?= __('Edit Color') ?>  <small></small></h2>
	...
	<div class="form-group">
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
					  <?php echo $this->Html->image('files/Colors/image/'.$color->image, ['alt'=>'color']);
        ...
        <?php
           /*  echo $this->Form->input('name');
			echo $this->Html->image('files/Colors/image/'.$color->image, ['alt'=>'color']);
