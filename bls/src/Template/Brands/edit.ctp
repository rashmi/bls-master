...
<div class="row">
    ...
    <div class="form-group">
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
					  <?php echo $this->Html->image('files/Brands/image/'.$brand->image, ['alt'=>'Logo', 'class'=>'img-thumbnail', 'width'=>'100px']); ?>
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
						<?php echo $this->Form->input('cates', ['id'=>'example-getting-started','default'=>$selected, 'options' => $list, 'multiple'=>true,'required'=> true, 'label' => false, 'class'=>'form-control col-md-7 col-xs-12'],['escape' => false]); ?>
                      </div>
                    </div>
					<div class="form-group">
        ...
        <?php
			...
			echo $this->Html->image('files/Brands/image/'.$brand->image, ['alt'=>'Logo', 'class'=>'img-thumbnail', 'width'=>'100px']);
